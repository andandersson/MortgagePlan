...
/** This class is providing test-methods for testing the logic
 ...
 is starting, as it is printing the results. */
public class DataControllerTest {	
	 ...
	 */
	@Test
	public void testCalculateMonthlyPayments() throws FileNotFoundException {
	 ...
	 */
	@Test
	public void testInitData() throws FileNotFoundException {
		dc = new DataController();
